...
<body>
	...
	<div class="w3-container">
		<a href="goodsMainAction.go"><img src="./images/logo.jpg"></a>
	 	<form class="w3-container" name="findform" action="memberPassFindAction.me" method="post" onsubmit="return inputCheck(this)">	
	 	
	 	 <label for="mem_id"><b>아이디</b></label>
         <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="ID"  name="mem_id" id="mem_id" value="${idFind }">
        	...
        	<p>
	 		...
	 		<button class="w3-button w3-block w3-theme-l3 w3-section w3-padding" type="submit">비밀번호 찾기</button>
	 		
	 		<button class="w3-button w3-block w3-theme-l3 w3-section w3-padding" type="button" id="login" onclick="location.href='memberIdFind.me'">아이디 찾기</button>
	 		
	 		<button class="w3-button w3-block w3-theme-l3 w3-section w3-padding" type="button" id="password" onclick="location.href='memberLogin.me'">로그인</button>
