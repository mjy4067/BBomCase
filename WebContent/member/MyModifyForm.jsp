...
<body>
	 ...
	 <h2 align="center">Member Modify</h2><p style="float: right; font-size: 12px; margin-right:100px;"><a href="goodsMainAction.go">홈</a> > <a href="memberMyPageAction.me">마이페이지</a> > 수정</p>
	<hr><br>
		
	<form class="w3-container" action="memberMyModifyAction.me" method="post" name="modifyform">
		...
		<table class="simple_table">
            ...
            <script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script>
		        ...
		        <tr>
		        	<th >등급</th>
		        	<td> <input class="w3-input w3-border w3-margin-bottom" type="text" name="mem_grade" id="mem_grade" value="${memberInfoResult.mem_grade}" readonly>  </td>
		        </tr>
		         <tr>
		            <th >가입일자</th>
